...
import {
  LOAN_PURPOSES, TENURE_LIMITS, ANNUAL_RATES, CO_APPLICANT_THRESHOLDS, EMPLOYMENT_ALLOWED_BY_LOAN_TYPE, PROCESSING_FEE_RATE, PROCESSING_FEE_MIN, PROCESSING_FEE_MAX,
} from './constants';
